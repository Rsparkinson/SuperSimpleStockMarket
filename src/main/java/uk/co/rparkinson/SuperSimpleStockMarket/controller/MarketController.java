...
public class MarketController {
  ...
  @RequestMapping("/")
  String home() {
      String t_text = "<p> SuperSimpleStockMarket </p>";
      MarketService.loadData();

      t_text = t_text + "<p>Example Assignment – Super Simple Stock Market </p>";
      t_text = t_text + "<p>Requirements </p>";
      t_text = t_text + "<p>  1. Provide working source code that will :- </p>";
      t_text = t_text + "<p>    i. Given any price as input, calculate the dividend yield </p>";
        ...
        t_text = t_text + "<p>     </p>";
        t_text = t_text + "<p>ii. Given any price as input, calculate the P/E Ratio     </p>";
        ...
        t_text = t_text + "<p>     </p>";
        t_text = t_text + "<p>    iii. Record a trade, with timestamp, quantity of shares, buy or sell indicator and traded price </p>";

        trade t_trade = new trade();
        t_trade.setSymbol("TEA");
        t_trade.setQty(10);
        t_trade.setType("Buy");
        t_trade.setTradePrice(12.12f);
        ...
        t_text = t_text + "<p>     </p>";
        t_text = t_text + "<p>    iv. Calculate Volume Weighted Stock Price based on trades in past 15 minutes</p>";
        ...
        t_text = t_text + "<p>     </p>";
        t_text = t_text + "<p>    b. Calculate the GBCE All Share Index using the geometric mean of prices for all stocks </p>";
        t_text = t_text + "<p>     </p>";
        t_text = t_text + "<p>     </p>";
